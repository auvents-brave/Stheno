...
public struct DateTime {
	...
	/// Initialises from an ISO 8601 string, accepting fractional seconds and time zone indicators.
	public init?(iso8601String: String) {
		// Normalise comma to dot for fractional seconds.
	...
	public func formatted(in targetType: DateTimeType, format: String = "yyyy-MM-dd HH:mm:ss") -> (
		date: String, time: String, unit: String
	) {
